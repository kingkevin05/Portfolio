          ...
          >
            ...
            <CardContent style={{padding: "22px"}} >
              ...
              <Typography
                ...
                component="div"
              >
                An application to help prevent domestic violence, enabling users
                to connect, share their experiences and support while also being
                able to share live location with their friends in case they're
                in danger.
              </Typography>
              <Typography
                variant="subtitle2"
          ...
          >
            ...
            <CardContent style={{padding: "22px"}}>
              ...
              <Typography
                ...
                component="div"
              >
                This app is made to give the user activity recommendations based
                on the weather in any given area. Nice weather makes the app
                with recommend outdoor activities while if the weather is bad,
                you'll be recommended indoor events.
              </Typography>
              <Typography
                variant="subtitle2"
                color="text.secondary"
          ...
          >
            ...
            <CardContent style={{padding: "22px"}}>
              ...
              >
                ...
                to their budget with or without a connection. If the user enters
                transactions offline, the total should be updated when they're
                brought back online.
              </Typography>
              <Typography
                variant="subtitle2"
          ...
          >
            ...
            <CardContent style={{padding: "22px"}}>
              ...
              <Typography
                ...
                component="div"
              >
                Swap Meet was created to help others meet, sell, and trade their
                possessions. Our services help people post listings through a
                simple user friendly interface and browse a variety of other
